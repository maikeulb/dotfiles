...
# c.InteractiveShell.banner1 = 'Python 3.4.3 (default, Oct 14 2015, 20:28:29) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.1.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  xcode, igor,
# algol, native, friendly, algol_nu, paraiso-dark, perldoc, trac, default,
# pastie, manni, fruity, paraiso-light, murphy, vim, bw, lovelace, emacs, tango,
# vs, monokai, borland, rrt, colorful, autumn
